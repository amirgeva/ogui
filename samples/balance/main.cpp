...
bool init()
{
  ...
  g_Window = SDL_CreateWindow("Balance", 100, 100, WIDTH, HEIGHT, SDL_WINDOW_SHOWN);
...
int main(int argc, char *argv[])
{
  ...
  while (!done)
  {
    ...
    while (SDL_PollEvent(&e)){
      ...
      if (e.type == SDL_MOUSEMOTION)     OGUIManager::instance()->mouse_move(e.motion.x, e.motion.y);
    }
